<?php include_once './includes/header.php'?>
    ...
    <!-- Banner Starts Here -->
    <?php display_banner('SEARCH QUERY', 'OUR RECENT BLOG ENTRIES') ?>
          ...
          <div class="col-lg-8">
            <div class="all-blog-posts">
              <div class="row">
                <?php
                  if (isset($_GET['q'])) {
                    $pagination_info = search_posts_pagination($_GET['q']);
                ...
                <div class="col-lg-12">
                  <ul class="page-numbers">
                    ...
                    display_pagination($pages_num, $current_page, "./search.php?q=$_GET[q]");
                    ?>
